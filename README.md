# Heritage Springs Lakes Paving Co &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `officerpavingco.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://officerpavingco.netlify.app |
...
├── pages/
│   ├── index.astro           # home (Officer primary)
...
├── whisper.js                # "Pete's Lead from Heritage Springs Lakes Paving Co &amp; Pergolas" played to contractor before patching caller through
...
| Telnyx TeXML app | `OfficerRetainingWalls-Voicemail` (id `2955788144311535476`) |
...
| `TENANT_BRAND` | `Heritage Springs Lakes Paving Co &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Heritage Springs Lakes Paving Co &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:officerpavingco.com.au`).
4. Set up Google Business Profile (needs registered business name "Heritage Springs Lakes Paving Co &amp; Pergolas" first).
5. Backlink work: hipages directory, True Local AU, Yelp AU, Heritage Springs Shire community pages.
6. Shortlist 2–3 retaining wall contractors in Officer; pitch the leads with a $1,500–$2,500/mo exclusive retainer.

## Niche-fit notes

| Factor | Why this niche |
|---|---|
| Local fit | Officer/Cockatoo estates are sloped — demand is structural, not weather-cyclical |
